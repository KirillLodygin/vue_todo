...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BzQOldip.mjs')
  },
  {
    name: "todo_list-todo_list_id",
    path: "/todo_list/:todo_list_id()",
    component: () => import('./index-DZCWDvxD.mjs')
  },
  {
    name: "todo_list",
    path: "/todo_list",
    component: () => import('./index-Dvg_gxKO.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CiydA5f-.mjs'))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Sd6wgMWm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CWnuYDpd.mjs'));
